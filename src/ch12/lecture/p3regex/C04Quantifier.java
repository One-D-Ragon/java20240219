...
public class C04Quantifier {
    public static void main(String[] args) {
        ...
        System.out.println("1".matches(p1)); // false
        ...
        String p55 = "[\\w가-힣]{1,}";
//        String p555 = "[.가-힣]{1,}";
        System.out.println("한국seoul".matches(p5));
        System.out.println("한국seoul".matches(p55));
//        System.out.println("한국seoul".matches(p555));
